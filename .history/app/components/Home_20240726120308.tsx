    ...
    return (
        <div className='bg-secondary relative px-4 md:px-0'>
            ...
            <div className='container mx-auto min-h-[calc(100vh-77px)] flex items-center relative'>
                ...
                <div 
                    className='{absolute top-3 inset-x-[7%] md:insert-x-[13%] rounded overflow-hidden transition duration-1000 ${
                        showPlayer ? "opacity-100 z-50" : "opacity-0 -z-10"
                    }}'>
                    <div className='flex items-center bg-black text-[#f9f9f9] p-3.5'>
                        <span className='font-semibold'>Play Trailer</span>
                        <div className='cursor-pointer w-8 h-8 flex  items-center rounded-lg opacity-50 hover:opacity-75 hover:bg-[#0F0F0F' onClick={() => setShowPlayer(false)}>
