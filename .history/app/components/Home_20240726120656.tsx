            ...
            <div className='container mx-auto min-h-[calc(100vh-77px)] flex items-center relative'>
                ...
                <div>
                    <div className='flex items-center justify-between bg-black text-[#f9f9f9] p-3.5'>
                        ...
                        <div className='cursor-pointer w-8 h-40 flex justify-center items-center rounded-lg opacity-50 hover:opacity-75 hover:bg-[#0F0F0F' onClick={() => setShowPlayer(false)}>
